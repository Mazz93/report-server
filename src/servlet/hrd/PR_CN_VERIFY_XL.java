...
@WebServlet("/PR_CN_VERIFY_XL")
public class PR_CN_VERIFY_XL extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           CallableStatement cs = con.prepareCall("{call OLL.PR_CN_VERIFY_XL(?,?)}");
            cs.setString(1, "PR_CN_VERIFY_XL");
...
response.sendRedirect("http://203.89.134.102/oracle/mis/PR_CN_VERIFY_XL.CSV");
