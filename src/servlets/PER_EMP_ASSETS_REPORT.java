	...
	@WebServlet("/PER_EMP_ASSETS_REPORT")
	public class PER_EMP_ASSETS_REPORT extends HttpServlet {
		...
		protected void doPost(HttpServletRequest request, HttpServletResponse response)
			...
			try {
				...
				CallableStatement cs = con.prepareCall("{call OLL.PER_EMP_ASSETS_REPORT(?,?,?)}");
				cs.setString(1, "AssestRep");
			    cs.setString(2, frdt);
				cs.setString(3, todt);
				...
				response.sendRedirect("http://203.89.134.102/oracle/mis/AssestRep.CSV");
