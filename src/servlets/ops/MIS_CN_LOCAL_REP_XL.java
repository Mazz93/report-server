...
@WebServlet("/MIS_CN_LOCAL_REP_XL")
public class MIS_CN_LOCAL_REP_XL extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String bcode = request.getParameter("BOOKING BRANCH");
		...
		try {
			...
			CallableStatement cs = con.prepareCall("{call OLL.MIS_CN_LOCAL_REP_XL(?,?,?,?,?)}");
			cs.setString(1, "CN_LOCAL_XL");
			...
			response.sendRedirect("http://203.89.134.102/oracle/mis/CN_LOCAL_XL.CSV");
